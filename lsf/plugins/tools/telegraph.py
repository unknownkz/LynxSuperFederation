...
bee = "LynxSFederation"
telegraph = Telegraph()
r = telegraph.create_account(short_name=bee)
auth_url = r["auth_url"]
TMP_DOWNLOAD_DIRECTORY = "./"


@tgb.on(events.NewMessage(pattern="^/tg(m|t)(?!\S+)"))
async def tgraph(event):
    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "m":
            ...
            user_object = await tgb.get_entity(r_message.sender_id)
...
*Post to Telegraph*
 ...
 • /tgm <reply media> : Get Telegraph Link Of Reply Media
 • /tgt <reply text> : Get Telegraph Link of Reply Text
"""
