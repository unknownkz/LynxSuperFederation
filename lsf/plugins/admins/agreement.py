...
UNAGREEALL = DisableAbleCommandHandler("unagreeall", unagreeall, run_async=True)
UNAGREEALL_BTN = CallbackQueryHandler(unagreeall_btn, pattern=r"unagreeall_.*", run_async=True)
