...
def join_fed(update: Update, context: CallbackContext):
    ...
    if user.id in SD_ID:
        ...
        for admin in administrators:
            status = admin.status
            if status == "creator" and "administrator":
                if str(admin.user.id) == str(user.id):
                    pass
                else:
                    update.effective_message.reply_text(
                        "Only group creators and administrator can use this command!",
                    )
                    return
...
def leave_fed(update: Update, context: CallbackContext):
    ...
    if getuser in "creator" or user.id in SD_ID:
...
__handlers__ = [
    ...
    BAN_FED_HANDLER,
    UN_BAN_FED_HANDLER,
    FED_BROADCAST_HANDLER,
    FED_SET_RULES_HANDLER,
    FED_GET_RULES_HANDLER,
    FED_CHAT_HANDLER,
    FED_ADMIN_HANDLER,
    FED_USERBAN_HANDLER,
    FED_NOTIF_HANDLER,
    FED_CHATLIST_HANDLER,
    FEDSTAT_USER,
    SET_FED_LOG,
    UNSET_FED_LOG,
    SUBS_FED,
    ...
    MY_SUB_FED,
    MY_FEDS_LIST,
    DELETEBTN_FED_HANDLER,
    FED_OWNER_HELP_HANDLER,
    FED_ADMIN_HELP_HANDLER,
    FED_USER_HELP_HANDLER,
]
