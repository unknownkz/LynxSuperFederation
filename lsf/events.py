...
def chataction(**args):
    ...
    def decorator(func):
        lynx_client.add_event_handler(func, events.ChatAction(**args))
        return func
...
def userupdate(**args):
    ...
    def decorator(func):
        lynx_client.add_event_handler(func, events.UserUpdate(**args))
        return func
...
def inlinequery(**args):
    ...
    def decorator(func):
        lynx_client.add_event_handler(func, events.InlineQuery(**args))
        return func
...
def callbackquery(**args):
    ...
    def decorator(func):
        lynx_client.add_event_handler(func, events.CallbackQuery(**args))
        return func
...
def BtCommand(**args):
    ...
    def decorator(func):
        ...
        lynx_client.add_event_handler(wrapper, events.NewMessage(**args))
        return wrapper
